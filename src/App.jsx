    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <p className="max-w-3xl text-gray-400 text-lg leading-8 mb-10">
          Early-career AI specialist with hands-on experience in machine learning, NLP, LLM-based systems and multimodal
          AI. Passionate about building practical, human-centred AI applications and transforming research ideas into real-
          world solutions.
